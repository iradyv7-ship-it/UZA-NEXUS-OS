...
const PAYMENT_GRANTS: Record<Role, readonly string[]> = {
  ...
  // login role — see backend/contracts/src/permissions.ts for the full reasoning.
 ...
 * the logistics coordinator role contract request (2026-09-14). Swap this to check for
