...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Sign in or create your UZA Move account for trips, wallet and savings." },
      ...
      <div className="mx-auto mt-8 w-full max-w-sm">
        ...
        >
          <svg viewBox="0 0 48 48" className="h-5 w-5" aria-hidden="true">
            ...
            <path fill="#34A853" d="M24 47.5c6.5 0 11.9-2.1 15.9-5.8l-7.6-5.9c-2.1 1.4-4.9 2.3-8.3 2.3-6.4 0-11.7-4.1-13.6-9.9l-7.8 6.1C6.5 42.1 14.6 47.5 24 47.5z" />
          </svg>
