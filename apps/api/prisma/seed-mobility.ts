...
const STEPS: Step[] = [
  ...
  {
    ref: 'INIT-2026-0211',
    name: 'Unguka referral list — 42 candidates in the pipeline',
    owner: SCORAH,
    attention: 'runs',
    targetDate: d('2026-09-12'),
    nextAction:
      'All 42 are loaded with UZA IDs, a place in the CAR queue and an open bank file. 294 of 421 outstanding items are generated by the platform; the 85 uploads and 42 CRB reports are the actual work. Start with the 85.',
  },
  {
    ref: 'INIT-2026-0212',
    ...
    nextAction:
      'Seven of the eleven items are marked generated and none of them generate yet. This is the single change that turns 693 documents a week from impossible into ordinary.',
  },
  {
    ref: 'INIT-2026-0203',
