...
export type WarehouseZone =
  'AWAITING_INSPECTION' | 'READY_FOR_LOADING' | 'QUARANTINE' | 'AWAITING_CORRECTION' | 'FRAGILE';
...
export type InspectionStage = 'pre_production' | 'during_production' | 'pre_shipment' | 'warehouse';
