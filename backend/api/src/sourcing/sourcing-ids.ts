 ...
 * keys were added from the supplier scoring and ids contract request (2026-07-25).
 *
 ...
 * the supplier deal ids policy and masking contract request (2026-09-14). Rendered
 * locally, same convention `supplier`/`rfq`/`supplierQuote` used before their own
 * ID_PATTERNS entries were accepted into the kernel. Delete these once the contract lands
 * and re-point at formatId.
 */
