 ...
 *
 * Mirrors README rule 1 ("payment gates procurement... never by an agent, never by AI")
...
export class SupplierDealService {
  ...
  async read(actor: Actor, ref: string) {
    ...
    // the supplier deal ids policy and masking contract request (2026-09-14). Until
