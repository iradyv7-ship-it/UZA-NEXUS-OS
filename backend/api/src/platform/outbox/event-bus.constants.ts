 ...
 * re-exported from `outbox-public.ts` so the publisher (backend/worker, running under tsx)
 * and the consumer (backend/api, running under SWC) agree on the queue name and job options
