 ...
 * OrderService/InvoiceService/… ) runs in backend/api, because those NestJS services need
 * constructor injection with `emitDecoratorMetadata`, which backend/api's SWC runtime emits
